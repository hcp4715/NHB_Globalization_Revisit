...
# fig2_abc <- fig2a + fig2b + fig2c + plot_annotation(tag_levels = 'A')#  + plot_layout(heights = c(1, 1.3))
# 
# ggsave("fig2_abc_NGData.pdf", fig2_abc, device = "pdf", width=15, height = 9)
...
ggsave("fig2_NG.pdf", fig2, device = "pdf", width=18, height = 15)
```
...
load(here::here("Re_Analysis_USA.RData"))
...
# fig3de <- fig3d + fig3e + plot_layout(guides = "collect")
# 
# ggsave("fig3_de_NGData.pdf", fig3de, device = "pdf", width=20, height = 15)
# 
# fig3de
...
ggsave("fig3_US.pdf", fig3, device = "pdf", width=18, height = 15)
